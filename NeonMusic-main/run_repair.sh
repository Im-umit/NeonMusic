...
echo "1/4: Eski ve çakışan dosyalar temizleniyor..."
...
echo "2/4: GitHub Actions Derleme Dosyası Oluşturuluyor..."
...
echo "3/4: Kodlar Yapılandırılıyor..."
...
cat << 'APPGRADLE' > app/build.gradle.kts
plugins {
...
# Application
cat << 'NEONAPP' > app/src/main/java/com/neonmusic/player/NeonApplication.kt
...
# MainActivity
cat << 'MAINACT' > app/src/main/java/com/neonmusic/player/MainActivity.kt
package com.neonmusic.player
...
# Color.kt
cat << 'COLOR' > app/src/main/java/com/neonmusic/player/ui/theme/Color.kt
...
# Theme.kt
cat << 'THEMEKT' > app/src/main/java/com/neonmusic/player/ui/theme/Theme.kt
package com.neonmusic.player.ui.theme
...
# Song.kt
cat << 'SONG' > app/src/main/java/com/neonmusic/player/domain/model/Song.kt
...
# MusicRepository.kt
cat << 'REPO' > app/src/main/java/com/neonmusic/player/data/repository/MusicRepository.kt
...
cat << 'REPOIMPL' > app/src/main/java/com/neonmusic/player/data/repository/MusicRepositoryImpl.kt
package com.neonmusic.player.data.repository
...
# AppModules.kt
cat << 'HILTMOD' > app/src/main/java/com/neonmusic/player/di/AppModules.kt
...
cat << 'SERVICE' > app/src/main/java/com/neonmusic/player/playback/MusicPlayerService.kt
...
git add -A
git commit -m "Clean build setup and workflow formatting fix"
git push -f origin main

echo "Tamamlandı! GitHub Actions bulut derlemesi başlatıldı."
